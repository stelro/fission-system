...
namespace fn {
  ...
  private:
    ...
    static void key_callback( GLFWwindow *window, int key, int scan_code,
                              int action, int modes ) noexcept;
  ...
  public:
    ...
    static IOManager *getInstnace() noexcept;
    ...
    void pressKey( int key ) noexcept;
