...
void VulkanBase::updateuniformbuffers(uint32_t currentimage) noexcept {
  ...
  ubo.view =
      glm::lookAt(glm::vec3(2.0f, 2.0f, 2.0f), glm::vec3(0.0, 0.0f, 0.0f),
  ...
  void *data;
  vkMapMemory(m_device, m_uniformBuffersMemory[currentimage], 0, sizeof(ubo), 0,
              &data);
...
void VulkanBase::createTexutureImage() noexcept {
